...
#' \href{National Grid}{http://www.ordnancesurvey.co.uk/oswebsite/gps/information/coordinatesystemsinfo/guidetonationalgrid/page1.html} coordinate system, based upon eastings (\code{x}) and northings
#' (\code{y}) instead of longitude and latitude.
#'
...
#'
#' ggplot(data = london_boroughs_murders) +
