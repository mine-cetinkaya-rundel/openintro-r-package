...
#' \item{phase_of_flt}{Phase of the flight during which the collision
#' occurred: \code{Approach}, \code{Climb}, \code{Descent}, \code{En Route},
#' \code{Landing Roll}, \code{Parked}, \code{Take-off run}, \code{Taxi}.}
#' \item{ac_mass}{Mass of the aircraft classified as 2250 kg or less
#' (1), 2251-5700 kg (2), 5701-27000 kg (3), 27001-272000 kg (4), above 272000
#' kg (5).}
#' \item{num_engs}{Number of engines on the aircraft.}
#' \item{date}{Date of the collision (MM/DD/YYYY).}
#' \item{time_of_day}{Light conditions: \code{Dawn}, \code{Day},
#' \code{Dusk}, \code{Night}.}
#' \item{state}{Two letter abbreviation of the US state in which the
#' collision occurred.}
#' \item{height}{Feet above ground level.}
#' \item{speed}{Knots (indicated air speed).}
#' \item{effect}{Effect on flight: \code{Aborted Take-off},
#' \code{Engine Shut Down}, \code{None}, \code{Other}, \code{Precautionary
#' Landing}.}
#' \item{sky}{Type of cloud cover, if any: \code{No Cloud}, \code{Overcast},
#' \code{Some Cloud}.}
#' \item{species}{Common name for bird or other wildlife.}
#' \item{birds_seen}{Number of birds/wildlife
#' seen by pilot: \code{1}, \code{2-10}, \code{11-100}, \code{Over 100}.}
...
#' library(tidyr)
#'
#' count(birds, phase_of_flt, sort = TRUE)
#'
#' ggplot(birds, aes(x = fct_infreq(phase_of_flt))) +
#'   geom_bar() +
...
#'   ggplot(aes(x = phase_of_flt, fill = effect)) +
#'     geom_bar(position = "fill") +
#'     labs(x = "Phase of flight", y = "Proportion", fill = "Effect") +
#'     coord_flip()
#'
NULL
